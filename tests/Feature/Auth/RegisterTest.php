...
class RegisterTest extends TestCase
{
    ...
    public function test_register_with_google_register_token(): void
    {
    ...
    public function test_register_with_email_register_token(): void
    {
    ...
    /**
     * Does not call login before registering and expects failure
     */
    public function test_does_not_register_on_missing_token(): void
    {
        ...
        $response->assertStatus(500); // Based on the Register action catching exceptions
    ...
    public function test_does_not_accept_empty_metadata(): void
    {
